...
namespace CimsApp.Tests.Services.Admin;
...
public class AdminServicesTests
{
    ...
    private sealed record TwoTenantFixture(
        ...
        StubTenantContext OrgATenant, CimsDbContext OrgADb,
        StubTenantContext SuperTenant, CimsDbContext SuperDb);
    ...
    private static Invitation SeedInvite(CimsDbContext db, Guid orgId, TimeSpan expiresIn)
    {
    ...
    private static void SeedAuditRow(CimsDbContext db, Guid? userId, string action, string entity, DateTime? createdAt = null)
    {
