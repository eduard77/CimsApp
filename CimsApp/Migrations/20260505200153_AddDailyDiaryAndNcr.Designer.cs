...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CimsApp.Models.AlertRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.AuditorProjectAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.CustomReportDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.DailyDiaryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.EvidenceArtefact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.ImprovementRegisterEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.InspectionActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.LessonLearned", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.Ncr", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.OpportunityToImprove", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.TidpEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CimsApp.Models.AlertRule", b =>
                {
                    ...
                    b.HasOne("CimsApp.Models.User", "RecipientUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CimsApp.Models.DailyDiaryEntry", b =>
                {
                    b.HasOne("CimsApp.Models.User", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("CimsApp.Models.EvidenceArtefact", b =>
                {
                    b.HasOne("CimsApp.Models.User", "AddedBy")
                        .WithMany()
                        .HasForeignKey("AddedById")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CimsApp.Models.AuditLog", "AuditLog")
                        .WithMany()
                    ...
                    b.HasOne("CimsApp.Models.InspectionActivity", "InspectionActivity")
                        .WithMany()
            ...
            modelBuilder.Entity("CimsApp.Models.InspectionActivity", b =>
                {
                    ...
                    b.HasOne("CimsApp.Models.User", "CancelledBy")
                        .WithMany()
                        .HasForeignKey("CancelledById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("CimsApp.Models.User", "CompletedBy")
                        .WithMany()
                    ...
                    b.HasOne("CimsApp.Models.User", "StartedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("CimsApp.Models.LessonLearned", b =>
                {
                    ...
                    b.HasOne("CimsApp.Models.Project", "SourceProject")
                        .WithMany()
            ...
            modelBuilder.Entity("CimsApp.Models.Ncr", b =>
                {
                    b.HasOne("CimsApp.Models.User", "AssignedTo")
                        .WithMany()
            ...
            modelBuilder.Entity("CimsApp.Models.TidpEntry", b =>
                {
                    b.HasOne("CimsApp.Models.MidpEntry", "MidpEntry")
                        .WithMany()
                    ...
                    b.HasOne("CimsApp.Models.User", "SignedOffBy")
                        .WithMany()
