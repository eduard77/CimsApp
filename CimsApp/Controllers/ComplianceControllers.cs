...
public class EvidenceController(
    EvidenceLibraryService svc, CimsDbContext db) : CimsControllerBase
{
    [HttpGet]
...
public class AdminAuditorAssignmentsController(AuditorAdminService svc) : CimsControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
...
public class AuditExportController(
    AuditExportService svc, CimsDbContext db) : CimsControllerBase
{
    /// <summary>
