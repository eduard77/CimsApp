...
public class AdminUsersController(UserAdminService svc) : CimsControllerBase
{
    [HttpGet]
...
[Authorize(Roles = "OrgAdmin,SuperAdmin")]
public class AdminOrganisationsController(OrganisationAdminService svc) : CimsControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
        [FromQuery] string? search = null,
...
[Authorize(Roles = "OrgAdmin,SuperAdmin")]
public class AdminInvitationsController(InvitationAdminService svc) : CimsControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
...
[Authorize(Roles = "OrgAdmin,SuperAdmin")]
public class AdminAuditController(AuditAdminService svc) : CimsControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
