...
/// (query filter in GeneraPmDbContext). Per PAFM-SD Appendix F.2 (S1 DoD).
/// </summary>
public class CostBreakdownItem
{
    ...
    /// GeneraPmDbContext. Null = not yet budgeted.</summary>
...
/// rows. Tenant-scoped indirectly through Project.AppointingPartyId
/// (query filter in GeneraPmDbContext). Per PAFM-SD Appendix F.3 (S2 DoD)
...
/// <see cref="GeneraPm.Core.ChangeWorkflow"/>. Multiple change
...
/// <see cref="GeneraPm.Core.TenderPackageWorkflow"/>. Soft-delete
...
/// <see cref="GeneraPm.Services.TenderPackagesService"/>'s
...
public class Contract
{
    ...
    /// defaults to <see cref="GeneraPm.Models.ContractForm.Other"/>
...
/// <see cref="GeneraPm.Core.CompensationEventWorkflow"/>.
...
/// enforcement in <see cref="GeneraPm.Core.GatewayPackageWorkflow"/>.
...
/// <see cref="GeneraPm.Core.DpiaWorkflow"/>. v1.0 ships free-text
...
/// machine via <see cref="GeneraPm.Core.PdcaWorkflow"/>:
...
/// Genera PM-quality-record half). Project-scoped. v1.0 ships the
...
/// <see cref="GeneraPm.Core.InspectionActivityWorkflow"/>.
/// </summary>
...
/// expiry the standard
/// <see cref="GeneraPm.Services.Auth.TokenRevocation.IsRevoked"/>
/// machinery (cutoff bump + refresh sweep, ADR-0014) denies
/// further access. Project-scoped read filter override at
/// GeneraPmDbContext checks for active assignment when the caller
