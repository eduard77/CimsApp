...
[ApiController]
[Authorize]
public abstract class GeneraPmControllerBase : ControllerBase
{
    ...
    protected async Task<UserRole> GetProjectRoleAsync(GeneraPmDbContext db, Guid projectId)
    {
...
// GeneraPmControllerBase) to bypass the [Authorize] baseline; that's
...
public class OrganisationsController(
    ...
    GeneraPm.Services.Tenancy.ITenantContext tenant) : GeneraPmControllerBase
{
    [HttpGet]
...
public class ProjectsController(ProjectsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List([FromQuery] string? search = null) =>
...
public class CdeController(CdeService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet("containers")]
...
public class CostController(CostService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpPost("import")]
...
public class CommitmentsController(CostService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpPost]
...
public class CostPeriodsController(CostService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpPost]
    public async Task<IActionResult> Create(
...
public class CashflowController(CostService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class EvmController(CostService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class ActualsController(CostService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpPost]
...
public class PaymentCertificatesController(PaymentCertificatesService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpPost]
...
public class VariationsController(VariationsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpPost]
...
public class RisksController(RisksService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class StakeholdersController(StakeholdersService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    {
...
public class CommunicationsController(CommunicationsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    {
...
public class ScheduleController(ScheduleService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet("activities")]
...
public class LpsController(LpsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    // ── Lookahead ──
    [HttpGet("lookahead")]
...
public class ChangeRequestsController(ChangeRequestService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class ProcurementStrategyController(ProcurementStrategyService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> Get(Guid projectId, CancellationToken ct)
    {
...
public class TenderPackagesController(TenderPackagesService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
...
public class TendersController(TendersService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
        Guid projectId, Guid tenderPackageId, CancellationToken ct)
...
public class EvaluationController(EvaluationService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
...
public class EarlyWarningsController(EarlyWarningsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
...
public class CompensationEventsController(CompensationEventsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
        Guid projectId, Guid contractId,
...
public class DashboardsController(DashboardsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet("pm")]
...
public class ReportingController(ReportingService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet("mpr")]
...
public class RopaController(RopaService svc) : GeneraPmControllerBase
{
    [HttpGet]
...
public class DpiaController(DpiaService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
...
public class SarController(SarService svc) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(CancellationToken ct) =>
        Ok(new { success = true, data = await svc.ListAsync(ct) });
...
public class DataBreachController(DataBreachService svc) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(CancellationToken ct) =>
        Ok(new { success = true, data = await svc.ListAsync(ct) });
...
public class RetentionSchedulesController(RetentionScheduleService svc) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(CancellationToken ct) =>
        Ok(new { success = true, data = await svc.ListAsync(ct) });
...
public class ImprovementRegisterController(ImprovementRegisterService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    { await GetProjectRoleAsync(db, projectId); return Ok(new { success = true, data = await svc.ListAsync(projectId, ct) }); }
...
public class LessonsLearnedController(LessonsLearnedService svc) : GeneraPmControllerBase
{
    [HttpGet]
...
public class OpportunityToImproveController(OpportunityToImproveService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class InspectionActivitiesController(InspectionActivityService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
        Guid projectId,
...
public class AlertRulesController(AlertRuleService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    {
...
public class SearchController(GeneraPm.Services.Search.SearchAggregatorService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class GatewayPackagesController(GatewayPackageService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    {
...
public class MorController(MorService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    {
...
public class SafetyCaseController(SafetyCaseService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet("summary")]
...
public class GoldenThreadController(DocumentsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    {
...
public class MidpController(MidpService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    {
...
public class TidpController(TidpService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(
...
public class CustomReportDefinitionsController(
    CustomReportDefinitionsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
    public async Task<IActionResult> List(Guid projectId, CancellationToken ct)
    {
...
public class DocumentsController(DocumentsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class RfisController(RfiService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class ActionsController(ActionsService svc, GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
...
public class AuditController(GeneraPmDbContext db) : GeneraPmControllerBase
{
    [HttpGet]
