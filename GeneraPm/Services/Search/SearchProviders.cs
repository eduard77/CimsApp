...
namespace GeneraPm.Services.Search;

/// <summary>
/// Searchable entity providers. T-S15-02. Each provider runs the
/// LIKE query through <see cref="GeneraPmDbContext"/>'s ordinary
...
public sealed class DocumentSearchProvider(GeneraPmDbContext db) : ISearchProvider
{
...
public sealed class RfiSearchProvider(GeneraPmDbContext db) : ISearchProvider
{
...
public sealed class ActionSearchProvider(GeneraPmDbContext db) : ISearchProvider
{
...
public sealed class RiskSearchProvider(GeneraPmDbContext db) : ISearchProvider
{
...
public sealed class ChangeRequestSearchProvider(GeneraPmDbContext db) : ISearchProvider
{
...
public sealed class EarlyWarningSearchProvider(GeneraPmDbContext db) : ISearchProvider
{
...
public sealed class CompensationEventSearchProvider(GeneraPmDbContext db) : ISearchProvider
{
