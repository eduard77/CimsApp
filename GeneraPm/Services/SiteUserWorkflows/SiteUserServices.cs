...
namespace GeneraPm.Services.SiteUserWorkflows;
...
public class DailyDiaryService(GeneraPmDbContext db, AuditService audit)
{
...
public class NcrService(GeneraPmDbContext db, AuditService audit)
{
    public const int DefaultTake = 50;
    public const int MaxTake = 200;
