...
namespace GeneraPm.Services.Admin;
...
public class UserAdminService(GeneraPmDbContext db, ITenantContext tenant, AuditService audit)
{
...
public class OrganisationAdminService(GeneraPmDbContext db, ITenantContext tenant, AuditService audit)
{
    public const int DefaultTake = 50;
    public const int MaxTake = 200;
...
public class InvitationAdminService(GeneraPmDbContext db, ITenantContext tenant, AuditService audit)
{
    public const int DefaultTake = 50;
    public const int MaxTake = 200;
...
public class AuditAdminService(GeneraPmDbContext db, ITenantContext tenant)
{
    public const int DefaultTake = 50;
    public const int MaxTake = 200;
