...
namespace GeneraPm.Services.Compliance;
...
public class EvidenceLibraryService(GeneraPmDbContext db, AuditService audit)
{
...
public class AuditorAdminService(
    GeneraPmDbContext db, ITenantContext tenant, AuditService audit, AuthService auth)
{
    public const int DefaultTake = 50;
    public const int MaxTake = 200;
...
public class AuditExportService(GeneraPmDbContext db)
{
    /// <summary>
