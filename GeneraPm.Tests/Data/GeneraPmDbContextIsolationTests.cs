...
namespace GeneraPm.Tests.Data;

/// <summary>
/// Runtime multi-tenant isolation behavioural tests (T-S0-04).
/// Companion to <see cref="GeneraPmDbContextTenantFilterTests"/> which only
...
/// </summary>
public class GeneraPmDbContextIsolationTests
{
    private static readonly Guid OrgA = Guid.NewGuid();
    private static readonly Guid OrgB = Guid.NewGuid();

    private static (DbContextOptions<GeneraPmDbContext> options, Guid userA, Guid userB, Guid projectA, Guid projectB)
    ...
    private static GeneraPmDbContext OpenAs(DbContextOptions<GeneraPmDbContext> options, Guid orgId, Guid userId) =>
