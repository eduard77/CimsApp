...
namespace GeneraPm.Tests.Services.Projects;
...
public class AddMemberOrgMatchTests
{
    ...
    private static ProjectsService NewService(DbContextOptions<GeneraPmDbContext> options,
        StubTenantContext tenant, out GeneraPmDbContext db)
    {
