...
namespace GeneraPm.Tests.Services.Compliance;
...
public class ComplianceServicesTests
{
    ...
    private static Fixture BuildFixture()
    {
        ...
        return new Fixture(orgId, projectId, actorId, tenant, new GeneraPmDbContext(options, tenant));
    }
    ...
    private static AuthService BuildAuthService(Fixture f)
    {
        ...
        var config = new ConfigurationBuilder()
            ...
            .Build();
        var tracker = new GeneraPm.Services.Auth.LoginAttemptTracker(
