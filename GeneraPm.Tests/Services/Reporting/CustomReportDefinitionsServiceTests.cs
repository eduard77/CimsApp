...
using Xunit;
using RiskEntity = GeneraPm.Models.Risk;

namespace GeneraPm.Tests.Services.Reporting;
...
public class CustomReportDefinitionsServiceTests
{
    ...
    private static (CustomReportDefinitionsService svc, GeneraPmDbContext db) NewSvc(
