...
using GeneraPm.Services.Notifications;
...
namespace GeneraPm.Tests.Services.Notifications;
...
public class NotificationPusherTests
{
    ...
    private static (GeneraPmDbContext db, FakeHubContext hub, Guid userId) Build()
    {
        ...
        return (new GeneraPmDbContext(options, tenant), new FakeHubContext(), userId);
    }
}
